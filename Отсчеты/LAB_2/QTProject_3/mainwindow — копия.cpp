...
void MainWindow::on_pushButton_2_clicked()
{
    ...
    while(Cou()){
                         ...
                         for(size_t k = h[1]; (!Count[i])  &&  (k < 4); k++){
                             for(size_t l = h[0]; (!Count[i]) && (l < 4); l++){
                                 ...
                                 auto iterat_A = [&](auto it, QVector<qint16> H, int i) -> QVector<double> {
                                   ...
                                   auto iterat_B = [&](auto it, QVector<qint16> H) -> QVector<double> {

                                      // qDebug() << "033\[31m" << H.count() << "033[0m";

                                       QVector<double> m(H.count(), 0);
        ...
        case(3):
                for(size_t j = 1; !Count[i]  &&  (j < 4); j++){
                    for(size_t k = 0; !Count[i]  &&  (k < 4); k++){
                         for(size_t z = 0; !Count[i]  &&  (z < 4); z++){
                             for(size_t l = 0; !Count[i] && (l < 4); l++){
                                ...
                                // H[0] = l;
                                 ...
                                 /////////////////////////////
                                 if(qAbs(*std::max_element(A[l].begin(),A[l].end())) > A[i][i]){
                                     H[0] = l;
                                     H[1] = -z;
                                     H[2] = k;
                                     H[3] = -j;
